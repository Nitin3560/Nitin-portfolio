...
export default function HeroSection() {
  return (
    <div className="relative w-full overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-950/88 text-white shadow-[0_30px_120px_rgba(10,10,20,0.28)]">
      <style>{`
      ...
      <div
        className="absolute inset-0 z-0 bg-[url(https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80)] bg-cover bg-center opacity-30"
        style={{
      ...
      />
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_top_right,rgba(255,205,117,0.18),transparent_28%),radial-gradient(circle_at_left_top,rgba(255,255,255,0.10),transparent_24%)]" />

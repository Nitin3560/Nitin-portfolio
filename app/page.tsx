  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-5xl px-6 pb-24 pt-12">
        <section className="relative overflow-hidden rounded-[2rem] border border-zinc-200/80 bg-white/80 px-8 py-14 shadow-[0_20px_80px_rgba(255,255,255,0.35)] backdrop-blur md:px-12 md:py-18">
